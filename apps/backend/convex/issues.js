...
export const create = mutation({
    args: {
        ...
        status: v.union(v.literal("shaping"), v.literal("todo"), v.literal("in_progress"), v.literal("in_review"), v.literal("done")),
        priority: v.number(),
...
export const update = mutation({
    args: {
        ...
        description: v.optional(v.string()),
        status: v.optional(v.union(v.literal("todo"), v.literal("in_progress"), v.literal("in_review"), v.literal("done"))),
...
export const upsertFromLinear = mutation({
    args: {
        ...
        linearUrl: v.string(),
        mappedStatus: v.union(v.literal("shaping"), v.literal("todo"), v.literal("in_progress"), v.literal("in_review"), v.literal("done")),
    },
