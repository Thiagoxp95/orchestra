  ...
  return (
    ...
    >
      <button
        ...
        className="flex items-center gap-3 min-w-0 cursor-pointer hover:brightness-110 transition-all"
      >
      ...
      <span
        ...
        className="text-[11px] shrink-0 opacity-40 hover:opacity-100 transition-opacity cursor-pointer self-start mt-0.5"
        style={{ color: textPrimary }}
      >
        ✕
      </span>
